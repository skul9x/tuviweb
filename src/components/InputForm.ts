...
export class InputForm {
                ...
                <form id="tuvi-form" class="input-form">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone" name="phone" class="input-field" placeholder="Nhập số điện thoại..." pattern="^0[3|5|7|8|9][0-9]{8}$">
    ...
    private handleFormSubmit(form: HTMLFormElement) {
        ...
        // Regex validation ONLY if phone is not empty
        if (phone) {
